	...
	if(!$_SESSION['admin']==1)
	{
		...
		if(isset($_GET['logout'])== 1)
		{
			...
			$num=$_POST['num'];
				...
				{ 
					$error="Thank you ms/mr email :".$msg. " your oder has been processed ";
  ...
  <div id="header">
    ...
    <div class="oferte_content">
      ...
      <div class="oferta">
        ...
        <p align="right"><a href="index.html?logout=1">Logout</a></div></td>&nbsp;
<p>&nbsp;</p><div class="top_divider"><img src="images/header_divider.png" alt="" width="1" height="164" /></div>
    </div>
