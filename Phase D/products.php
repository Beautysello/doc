  ...
  <div id="main_content">
    <div id="menu_tab">
      ...
      <ul class="menu">
        ...
        <li class="divider"></li>
        <li><a href="login.php" class="nav4">Logout</a><a href="contact.php" class="nav6">Contact Us</a></li>
        <li class="divider"></li>
    ...
    <div class="center_content">
      ...
      <div class="prod_box_big">
        <div class="center_prod_box_big">
          ...
          <tr>
            <td width="540" height="30" align="center">components</td>
          </tr>
        
          <tr>
          <td height="270"><?php echo $dis_prod;?>
            </td>
          </tr>
