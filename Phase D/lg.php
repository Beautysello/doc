  ...
  <div id="main_content">
    ...
    <div class="left_content">
      ...
      <div class="border_box">
        ...
        <div class="product_img"><img src="images/laptop.png" alt="" border="0" /></div>
    ...
    <div class="center_content">
      ...
      <div class="prod_box">
        ...
        <div class="center_prod_box">
          ...
          <div class="product_img"><img src="images/aaa.jpg" alt="" width="122" height="100" border="0" /></div>
          <div class="prod_price">R<span class="price">3370</span></div>
        </div>
      ...
      <div class="prod_box">
        ...
        <div class="center_prod_box">
          <div class="product_title"></div>
          <div class="product_img"><img src="images/nn.jpg" alt="" width="159" height="106" border="0" /></div>
          <div class="prod_price"><span class="price">R2270</span></div>
        </div>
        <div class="bottom_prod_box"></div>
        <div class="prod_details_tab"> <a href="" title="header=[Add to cart] body=[&nbsp;] fade=[on]"><img src="images/cart.gif" alt="" border="0" class="left_bt" /></a></div>
      </div>
      <div class="prod_box">
        ...
        <div class="center_prod_box">
          ...
          <div class="product_img"><img src="images/ddd.jpg" alt="" width="138" height="89" border="0" /></div>
          <div class="prod_price">R<span class="price">2270</span></div>
        </div>
        <div class="bottom_prod_box"></div>
        <div class="prod_details_tab"> <a href="" title="header=[Add to cart] body=[&nbsp;] fade=[on]"><img src="images/cart.gif" alt="" border="0" class="left_bt" /></a></div>
      </div>
