    ...
    <div class="center_content">
      ...
      <div class="prod_box">
        ...
        <div class="center_prod_box">
          ...
          <div class="product_img"><img src="images/uu.jpg" alt="" width="143" height="89" border="0" /></div>
          <div class="prod_price">R7000</div>
        </div>
      ...
      <div class="prod_box">
        ...
        <div class="center_prod_box">
          <div class="product_title"></div>
          <div class="product_img"><img src="images/ss.jpg" alt="" width="173" height="89" border="0" /></div>
          <div class="prod_price">R7000</div>
        </div>
        <div class="bottom_prod_box"></div>
        <div class="prod_details_tab"></div>
      ...
      <div class="prod_box">
        ...
        <div class="center_prod_box">
          <div class="product_title"></div>
          <div class="product_img"><img src="images/uuu.jpg" alt="" height="79" border="0" /></div>
          <div class="prod_price">R7000</div>
        </div>
        <div class="bottom_prod_box"></div>
        <div class="prod_details_tab"></div>
