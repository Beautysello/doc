...
<div id="main_container">
  ...
  <div id="main_content">
    ...
    <div class="center_content">
      <div class="center_title_bar">Sumsung products</div>
      <div class="prod_box">
        <div class="top_prod_box"></div>
        <div class="center_prod_box">
          <div class="product_title"></div>
          <div class="product_img"><img src="images/gg.jpg" alt="" width="165" height="124" border="0" /></div>
          <div class="prod_price">R2000</div>
        </div>
      ...
      <div class="prod_box">
        ...
        <div class="center_prod_box">
          <div class="product_title"></div>
          <div class="product_img"><img src="images/bbb.jpg" alt="" width="171" height="127" border="0" /></div>
          <div class="prod_price">R3000</div>
        </div>
        <div class="bottom_prod_box"></div>
        <div class="prod_details_tab"></div>
      </div>
      <div class="prod_box">
        ...
        <div class="center_prod_box">
          <div class="product_title"></div>
          <div class="product_img"><img src="images/ccc.jpg" alt="" width="120" height="116" border="0" /></div>
          <div class="prod_price">R2500</div>
        </div>
        <div class="bottom_prod_box"></div>
        <div class="prod_details_tab"></div>
      </div>
