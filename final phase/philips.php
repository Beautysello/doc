    ...
    <div class="center_content">
      ...
      <div class="prod_box">
        ...
        <div class="center_prod_box">
          ...
          <div class="product_img"><img src="images/laptop.png" alt="" width="94" height="92" border="0" /></div>
          <div class="prod_price">R3500</div>
        </div>
      ...
      <div class="prod_box">
        ...
        <div class="center_prod_box">
          <div class="product_title"></div>
          <div class="product_img"><img src="images/ff.jpg" alt="" width="102" height="99" border="0" /></div>
          <div class="prod_price">R4000</div>
        </div>
        <div class="bottom_prod_box"></div>
        <div class="prod_details_tab"></div>
      </div>
      <div class="prod_box">
        ...
        <div class="center_prod_box">
          ...
          <div class="prod_price">R4500</div>
        </div>
        <div class="bottom_prod_box"></div>
        <div class="prod_details_tab"></div>
      </div>
