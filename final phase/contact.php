...
<head>
<title>Electro Store - Contact</title>
        ...
        <div class="center_prod_box_big">
          <div class="contact_form">
            ...
            <div class="form_row">
              ...
              <input type="text" class="contact_input" name="com" />
            </div>
            <div class="form_row">
			...
			echo "wrong email format";
			 ...
			 $query = "insert into contact values(null,'$name','$email','$phone','com','$msg')";
			 $result =$db->query($query);
				if(!$result)
				{
				  echo"coudnt submit to the database ";
				  exit;
				}
				else if(!preg_match("/^\+27[786]{1}[0-9]{1}-[0-9]{3}-[0-9]{4}$/", $phone)) {
  			    echo"Wrong number";
			   }
			  ?>
            </div>
