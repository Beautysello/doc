        ...
        <label for="radio">User</label>
          ...
          <table width="322" >
            ...
            <tr>
              ...
              <td><input type="password" name="passwrd" id="passwrd" /></td>
            </tr>
            <tr>
...
<p>
  <?php
   require("sql_commands.class.php");
	...
	$obj->addUser($name,$Lname,$username,$email,$cell,$pass,$rpass);
...
?>
  ...
  <div class="footer">
    ...
    <div class="right_footer"> <a href="index.php">home</a> <a href="about.html">abou</a>t<a href="contact.php">contact us</a> </div>
  </div>
</div>
